			...
			<div class="container-content" id="container-content-1"
				...
				<div class="container-content-column">
					<ul id="container-content-column" style="display: block;">
						<s:iterator id="id" value="knowiceV">
							...
							<li><a id="pic" href="<s:property value="name" />"
								...
								<s:if test="%{#session.grade==1}">
									<a
										href="filedelete?tableName=image_characteristics_extraction&id=<s:property value="id" />&fileName=<s:property value="path" />\<s:property value="name" />">删除</a>
								</s:if></li>
						</s:iterator>
					</ul>
					<ul id="container-content-column">
						<s:iterator id="id" value="knowiceS">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="knowiceB">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="knowiceD">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="knowiceO">

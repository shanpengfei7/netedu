			...
			<div class="container-content" id="container-content-1"
				...
				<div class="container-content-column">
					<ul id="container-content-column" style="display: block;">
						<s:iterator id="id" value="knowppV">
							...
							<li><a id="pic" href="<s:property value="name" />"
								...
								<s:if test="%{#session.grade==1}">
									<a
										href="filedelete?tableName=pattern_recognition&id=<s:property value="id" />&fileName=<s:property value="path" />\<s:property value="name" />">删除</a>
								</s:if></li>
						</s:iterator>
					</ul>
					<ul id="container-content-column">
						<s:iterator id="id" value="knowppS">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="knowppB">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="knowppD">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="knowppO">

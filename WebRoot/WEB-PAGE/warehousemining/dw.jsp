			...
			<div class="container-content" id="container-content-1"
				...
				<div class="container-content-column">
					<ul id="container-content-column" style="display: block;">
						<s:iterator id="id" value="knowdwV">
							...
							<li><a id="pic" href="<s:property value="name" />"
								...
								<s:if test="%{#session.grade==1}">
									<a
										href="filedelete?tableName=dw&id=<s:property value="id" />&fileName=<s:property value="path" />\<s:property value="name" />">删除</a>
								</s:if></li>
						</s:iterator>
					</ul>
					<ul id="container-content-column">
						<s:iterator id="id" value="knowdwS">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="knowdwB">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="knowdwD">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="knowdwO">

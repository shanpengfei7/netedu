	...
	<div class="container">
		...
		<div>
			<div class="container-content" id="container-content-1"
				...
				<div class="container-content-column">
					<ul id="container-content-column" style="display: block;">
						<s:iterator id="id" value="openstackV">
							...
							<li><a id="pic" href="<s:property value="name" />"
								...
								<s:if test="%{#session.grade==1}">
									<a
										href="filedelete?tableName=cloud_management_platform&id=<s:property value="id" />&fileName=<s:property value="path" />\<s:property value="name" />">删除</a>
								</s:if></li>
						</s:iterator>
					</ul>
					<ul id="container-content-column">
						<s:iterator id="id" value="openstackS">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="openstackB">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="openstackD">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="openstackO">
			...
			<div class="container-content" id="container-content-2">
				...
				<div class="container-content-column">
					<ul id="container-content-column" style="display: block;">
						<s:iterator id="id" value="cloudstackV">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="cloudstackS">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="cloudstackB">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="cloudstackD">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="cloudstackO">

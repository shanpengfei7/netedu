			...
			<div class="container-content" id="container-content-1" style="display:block">
				...
				<div class="container-content-column">
					<ul id="container-content-column" style="display: block;">
						<s:iterator id="id" value="knowdaaV">
							...
							<li><a id="pic" href="<s:property value="name" />"
								...
								<s:if test="%{#session.grade==1}">
									<a
										href="filedelete?tableName=data_analysis_algorithms&id=<s:property value="id" />&fileName=<s:property value="path" />\<s:property value="name" />">删除</a>
								</s:if></li>
						</s:iterator>
					</ul>
					<ul id="container-content-column">
						<s:iterator id="id" value="knowdaaS">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="knowdaaB">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="knowdaaD">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="knowdaaO">

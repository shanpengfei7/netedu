						...
						<s:iterator id="id" value="knowpV">
							...
							<li><a id="pic" href="<s:property value="name" />"
								...
								<s:if test="%{#session.grade==1}">
									<a
										href="filedelete?tableName=probability_theory&id=<s:property value="id" />&fileName=<s:property value="path" />\<s:property value="name" />">删除</a>
								</s:if></li>
						</s:iterator>
					</ul>
					<ul id="container-content-column">
						<s:iterator id="id" value="knowpS">

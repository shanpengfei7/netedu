	...
	<div class="container">
		...
		<div>
						...
						<s:iterator id="id" value="LinuxV">
							...
							<li><a id="pic" href="<s:property value="name" />"
								...
								<s:if test="%{#session.grade==1}">
									<a
										href="filedelete?tableName=operating_system&id=<s:property value="id" />&fileName=<s:property value="path" />\<s:property value="name" />">删除</a>
								</s:if></li>
						</s:iterator>
					</ul>
					<ul id="container-content-column">
						<s:iterator id="id" value="LinuxS">
			...
			<div class="container-content" id="container-content-2">
				...
				<div class="container-content-column">
					<ul id="container-content-column" style="display: block;">
						<s:iterator id="id" value="WindowsV">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="WindowsS">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="WindowsB">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="WindowsD">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="WindowsO">

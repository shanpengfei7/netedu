	...
	<div class="container">
		...
		<div>
						...
						<s:iterator id="id" value="CCV">
							...
							<li><a id="pic" href="<s:property value="name" />"
								...
								<s:if test="%{#session.grade==1}">
									<a
										href="filedelete?tableName=program_language&id=<s:property value="id" />&fileName=<s:property value="path" />\<s:property value="name" />">删除</a>
								</s:if></li>
						</s:iterator>
					</ul>
					<ul id="container-content-column">

						<s:iterator id="id" value="CCS">
			...
			<div class="container-content" id="container-content-3">
				...
				<div class="container-content-column">
					<ul id="container-content-column" style="display: block;">
						<s:iterator id="id" value="PythonV">
					...
					<ul id="container-content-column">
						...
						<s:iterator id="id" value="PythonS">
					...
					<ul id="container-content-column">
						...
						<s:iterator id="id" value="PythonB">
					...
					<ul id="container-content-column">
						...
						<s:iterator id="id" value="PythonD">
					...
					<ul id="container-content-column">
						<s:iterator id="id" value="PythonO">

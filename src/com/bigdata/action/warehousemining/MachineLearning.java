...
public class MachineLearning extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		knowmV = serviceDaoImpl.getList("MachineLearning", "知识", "视频资料");
		knowmS = serviceDaoImpl.getList("MachineLearning", "知识", "学习笔记");
		knowmB = serviceDaoImpl.getList("MachineLearning", "知识", "电子书类");
		knowmD = serviceDaoImpl.getList("MachineLearning", "知识", "参考文献");
		knowmO = serviceDaoImpl.getList("MachineLearning", "知识", "其它资料");
		return SUCCESS;
	}
}
